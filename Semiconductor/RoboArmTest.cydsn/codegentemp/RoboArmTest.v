// ======================================================================
// RoboArmTest.v generated from TopDesign.cysch
// 12/05/2018 at 21:19
...
module ADC_SAR_v3_10_0 (
	...
	cy_clock_v1_0
		#(.id("b0b6e541-e838-4ca6-8d41-7b906d5aaea8/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("b0b6e541-e838-4ca6-8d41-7b906d5aaea8/16a808f6-2e13-45b9-bce0-b001c8655113"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("91228d6b-1958-4d8a-b790-bc55b6b5c0b6"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__Pot_3_net;
	wire [0:0] tmpFB_0__Pot_3_net;
	wire [0:0] tmpIO_0__Pot_3_net;
	wire [0:0] tmpINTERRUPT_0__Pot_3_net;
	electrical [0:0] tmpSIOVREF__Pot_3_net;

	cy_psoc3_pins_v1_10
		#(.id("9b2b7f00-c41a-4b1f-9950-c64a7d6faa65"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Pot_3
		 (.oe(tmpOE__Pot_3_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pot_3_net[0:0]}),
		  .analog({Net_186}),
		  .io({tmpIO_0__Pot_3_net[0:0]}),
		  .siovref(tmpSIOVREF__Pot_3_net),
		  .interrupt({tmpINTERRUPT_0__Pot_3_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pot_3_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    // -- AMux Pot_Values start -- ***
    // -- Mux A --
    
    cy_psoc3_amux_v1_0 Pot_Values(
        .muxin({
            Net_186,
            Net_185,
            Net_184
    ...
    defparam Pot_Values.muxin_width = 3;
    defparam Pot_Values.init_mux_sel = 3'h0;
    defparam Pot_Values.one_active = 0;
    defparam Pot_Values.connect_mode = 1;
    ...
    UART_v2_50_1 UART (
        ...
        .reset(1'b0),
        .rx(Net_242),
        .tx_interrupt(Net_248),
        .rx_interrupt(Net_249),
        .tx_data(Net_250),
        .tx_clk(Net_251),
        .rx_data(Net_252),
        .rx_clk(Net_253));

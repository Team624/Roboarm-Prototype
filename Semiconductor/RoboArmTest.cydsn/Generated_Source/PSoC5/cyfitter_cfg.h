...
extern void Pot_Values_Set(uint8 channel);
extern void Pot_Values_Unset(uint8 channel);
/* Pot_Values__addrTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern uint8 CYXDATA * const CYCODE Pot_Values__addrTable[6];
/* Pot_Values__maskTable is an implementation detail of the AMux.
   Code that depends on it may be incompatible with other versions
   of PSoC Creator. */
extern const uint8 CYCODE Pot_Values__maskTable[6];

...
*
* \funcusage
*  \snippet Pot_2_SUT.c usage_Pot_2_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pot_2_SUT.c usage_Pot_2_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Pot_2_SUT.c usage_Pot_2_Read  
*******************************************************************************/
...
* preferred Pot_2_Read() API because the 
* Pot_2_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Pot_2_SUT.c usage_Pot_2_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Pot_2_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Pot_2_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Pot_2_0_INTR       (First pin in the list)
    *  - Pot_2_1_INTR       (Second pin in the list)
    *  - ...
    *  - Pot_2_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Pot_2_SUT.c usage_Pot_2_SetInterruptMode
    *******************************************************************************/
    void Pot_2_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Pot_2_0_INTR) != 0u) 
		{ 
			 Pot_2_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Pot_2_SUT.c usage_Pot_2_ClearInterrupt
    *******************************************************************************/

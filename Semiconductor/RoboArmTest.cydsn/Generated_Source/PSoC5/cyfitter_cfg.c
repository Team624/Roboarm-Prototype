...
#define BS_UDB_0_1_1_CONFIG_VAL ((const uint8 CYFAR *)0x480002D8u)

/* IOPINS0_0 Address: CYREG_PRT0_DM0 Size (bytes): 8 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)0x48000358u)

/* IOPINS0_7 Address: CYREG_PRT12_DR Size (bytes): 10 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)0x48000360u)

/* IOPINS0_1 Address: CYREG_PRT1_DM0 Size (bytes): 8 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)0x4800036Cu)

/* IOPINS0_3 Address: CYREG_PRT3_DM0 Size (bytes): 8 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)0x48000374u)

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 4 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x4800037Cu)
...
uint8 CYXDATA * const CYCODE Pot_Values__addrTable[6] = {
	(uint8 CYXDATA *)CYREG_PRT0_AG, (uint8 CYXDATA *)CYREG_SAR0_SW0, 
	(uint8 CYXDATA *)CYREG_PRT0_AG, (uint8 CYXDATA *)CYREG_SAR0_SW0, 
	(uint8 CYXDATA *)CYREG_PRT3_AG, (uint8 CYXDATA *)CYREG_SAR0_SW0, 
};

/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE Pot_Values__maskTable[6] = {
	0x01u, 0x10u, 
	0x02u, 0x20u, 
	0x40u, 0x40u, 
};
...
*
*******************************************************************************/
void Pot_Values_Set(uint8 channel)
{
	if (channel < 3)
	{
		channel += channel;
		*Pot_Values__addrTable[channel] |= Pot_Values__maskTable[channel];
		channel++;
		*Pot_Values__addrTable[channel] |= Pot_Values__maskTable[channel];
	}
}
...
/*******************************************************************************
* Function Name: Pot_Values_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void Pot_Values_Unset(uint8 channel)
{
	if (channel < 3)
	{
		channel += channel;
		*Pot_Values__addrTable[channel] &= (uint8)~Pot_Values__maskTable[channel];
		channel++;
		*Pot_Values__addrTable[channel] &= (uint8)~Pot_Values__maskTable[channel];
	}
}
